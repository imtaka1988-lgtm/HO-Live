...
const DEFAULT_CONFIG = {
  app: {
    ...
    tag: "主推",
    title: "海鸥聊天 App",
    desc: "当前主推的私域聊天入口，后续也可以替换成其他聊天软件或群组平台。",
    qrImage: "",
    customerId: "待配置",
    groupId: "待配置",
    buttonText: "入口待配置",
  ...
  official: {
    ...
    tag: "公众号",
    title: "微信公众号",
    desc: "关注公众号，接收直播入口、赛前提醒、赛事分析和回放更新。",
    qrImage: "",
    accountName: "待配置",
...
function normalizeConfig(input) {
  ...
  return {
    app: {
      ...
      qrImage: cleanText(src.app && src.app.qrImage, 255),
      ...
      buttonLink: cleanText(src.app && src.app.buttonLink, 255)
    },
    wechat: {
      ...
      serviceQrImage: cleanText(src.wechat && src.wechat.serviceQrImage, 255),
      groupQrImage: cleanText(src.wechat && src.wechat.groupQrImage, 255),
    ...
    official: {
      ...
      qrImage: cleanText(src.official && src.official.qrImage, 255),
